                    ...
                    <form action="{{ route('pegawai.store') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid" id="nama_pegawai" name="nama_pegawai"
                                type="text" placeholder="Contoh: Budi" value="{{ old('nama_pegawai') }}">
                        </div>

                        <div class="mb-3">
                            <label for="namapegawailabel">Alamat Pegawai</label>
                            <input class="form-control form-control-solid" id="alamat" name="alamat" type="text"
                                placeholder="Contoh: Bojongsoang" value="{{ old('alamat') }}">
                        </div>

                        <div class="mb-3">
                            <label for="no_hplabel">Nomor Telepon</label>
                            <input class="form-control form-control-solid" id="no_hp" name="no_hp"
                                type="text" placeholder="Contoh: 081234567890" value="{{ old('no_hp') }}">
                        </div>a
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid" id="email" name="email" type="email"
                                placeholder="Contoh: email@example.com" value="{{ old('email') }}">
                        </div>
