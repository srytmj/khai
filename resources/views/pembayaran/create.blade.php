                    ...
                    <form action="{{ route('pembayaran.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <fieldset disabled>
                            <div class="mb-3"><label for="kodeperusahaanlabel">No Transaksi</label>
                                <input class="form-control form-control-solid" id="kode" name="kode" type="text"
                                    value="{{ $no_transaksi }}" readonly>
                            </div>
                        </fieldset>
                        <div class="mb-3"><label for="namaperusahaanlabel">Isi Keranjang
                                <b>({{ rupiah($totaltagihan) }})</b></label>
                            <ul class="list-group">
                                @foreach ($keranjang as $k)
                                            ...
                                            <div class="col-sm-10" align="left">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>=</td>
                                                        <td style="text-align:right">{{ rupiah($k->harga_menu) }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            Jumlah Barang
                                                        ...
                                                        <td>=</td>
                                                        <td style="text-align:right">{{ number_format($k->jml_barang) }}
                                                        </td>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="file" class="form-control @error('bukti_bayar') is-invalid @enderror"
                                    id="bukti_bayar" name="bukti_bayar" value="{{ old('bukti_bayar') }}">
                                @error('bukti_bayar')
                                    <div>{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control @error('tgl_bayar') is-invalid @enderror"
                                    id="tgl_bayar" name="tgl_bayar" value="{{ old('tgl_bayar') }}">
                                @error('tgl_bayar')
                                    <div>{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <a class="col-sm-1 btn btn-dark  btn-sm" href="{{ url('/pembayaran/viewkeranjang') }}"
                            role="button">Batal</a>
