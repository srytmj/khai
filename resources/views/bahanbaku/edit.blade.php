                    ...
                    <form action="{{ route('bahanbaku.update', $bahanbaku->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <fieldset disabled>
                            <div class="mb-3"><label for="kodebahanbakulabel">Kode Bahan Baku</label>
                                <input class="form-control form-control-solid" id="kode_bahan_baku_tampil"
                                    ...
                                    value="{{ $bahanbaku->kode_bahanbaku }}" readonly>
                            </div>
                        </fieldset>
                        
                        <input type="hidden" id="kode_bahanbaku" name="kode_bahanbaku"
                            value="{{ $bahanbaku->kode_bahanbaku }}">
                        ...
                        <div class="mb-3"><label for="namabahanbakulabel">Nama bahanbaku</label>
                            <input class="form-control form-control-solid" id="nama_bahanbaku" name="nama_bahanbaku"
                                type="text" placeholder="Contoh: ayam goreng" value="{{ $bahanbaku->nama_bahanbaku }}">
                        </div>

                        <div class="mb-3"><label for="satuan_bahanbaku">Satuan bahanbaku</label>
                            <input class="form-control form-control-solid" id="satuan_bahanbaku" name="satuan_bahanbaku"
                                type="text" placeholder="Contoh: ayam goreng" value="{{ $bahanbaku->satuan_bahanbaku }}">
                        </div>
