            ...
            <h5 class="card-title fw-semibold mb-4">Data Bahan Baku</h5>
                ...
                <form action="/bahanbaku" method="post">
                    ...
                    <fieldset disabled>
                        <div class="mb-3"><label for="kodebahanbakulabel">Kode Bahan Baku</label>
                            <input class="form-control form-control-solid" id="kode_bahan_baku_tampil"
                                name="kode_bahan_baku_tampil" type="text" placeholder="Contoh: BB-001"
                                value="{{ $kode_bahan_baku }}" readonly>
                        </div>
                    </fieldset>
                    <input type="hidden" id="kode_bahan_baku" name="kode_bahan_baku" value="{{ $kode_bahan_baku }}">
                    
                    <div class="mb-3"><label for="namabahanbakulabel">Nama Bahan Baku</label>
                        <select name="nama_bahan_baku" class="form-select" aria-label="Default select example">
                    ...
                    <div class="mb-0"><label for="stockbahanbakulabel">Stock Bahan Baku</label>
                        <input type="number" class="form-control form-control-solid" id="stock_bahan_baku"
                            name="stock_bahan_baku" rows="3"
                            placeholder="Cth: Stock Mie 45">{{ old('stock_bahan_baku') }}</input>
                    </div>
                    <br>
                    <!-- untuk tombol simpan -->
