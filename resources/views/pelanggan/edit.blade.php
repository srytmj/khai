          ...
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Data pelanggan</h5>
                ...
                <form action="{{ route('pelanggan.update', $pelanggan->id) }}" method="post">
                    ...
                    <input class="form-control form-control-solid" id="nama_pelanggan" name="nama_pelanggan" type="text" placeholder="budi" value="{{$pelanggan->nama_pelanggan}}">
                    </div>
                    
        
                    <div class="mb-0"><label for="alamatlabel">alamat</label>
                        <textarea class="form-control form-control-solid" id="alamat" name="alamat" rows="3" placeholder="Cth: Jl Bojongsoang Indah">{{$pelanggan->alamat}}</textarea>
                    </div>

                    <div class="mb-3"><label for="nohplabel">No Handphone</label>
                    <input class="form-control form-control-solid" id="no_hp" name="no_hp" type="text" placeholder="budi" value="{{$pelanggan->no_hp}}">
                    </div>
                    <br>
                    <!-- untuk tombol simpan -->
