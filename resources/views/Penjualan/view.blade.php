                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="card shadow mb-8">
                                        ...
                                        <a href="#collapseCardExample{{ $p->id }}" class="d-block card-header py-3"
                                            ...
                                            <h6 class="m-0 font-weight-bold text-primary">{{ $p->nama_menu }}</h6>
                                        </a>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-4" align="justify">
                                                        <i class="ti ti-package"></i>&nbsp;&nbsp;Stok <b
                                                            id="xstok-{{ $p->id }}">{{ $p->stok }}</b><br><br>
                                                        <i class="ti ti-credit-card"></i>
                                                        {{ rupiah($p->harga_menu) }} <br><br>
                                                        <a href="#"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="#" class="formpenjualan" method="post">
                                ...
                                <div class="mb-3 row">
                                    <label for="nomerlabel" class="col-sm-4 col-form-label">Nama Menu</label>
                                    <div class="col-sm-8">
                    ...
                    $('.tampilmodaltambah').on('click', function() {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $('#nama_menu').val(response.menu[0].nama_menu);
                                $('#harga_menu').val(number_format(response.menu[0].harga_menu));
                                $('#jumlah').attr({
                                    'min': 1,
                                    'max': response.menu[0].stok
                                });
                                $('#idmenuhidden').val(response.menu[0].id);
                            }
